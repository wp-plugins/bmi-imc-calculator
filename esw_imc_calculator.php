...
class IMC_Calculator_wydget extends WP_Widget {
	...
	public function widget( $args, $instance ) {   
		...
		if ( $sistema_metrico == "Metrico" ):
			$peso = "KG";
			$altura = "CM";
		elseif ( $sistema_metrico == "Imperial" ):
			$peso = "LB";
			$altura = "IN";
		endif;
		...
		<!-- FORMULARIO IMC -->
		<form id="CalculoIMC">
			<input name="sistema_metrico" id="sistema_metrico" type="hidden" value="<?php echo $sistema_metrico ?>" >
